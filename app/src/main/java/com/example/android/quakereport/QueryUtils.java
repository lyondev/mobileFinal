...
public final class QueryUtils {
     ...
     */
    public static List<Earthquake> extractEarthquakesFromJson(String earthquakeJsonResponse) {
        ...
        try {
            ...
            for (int i = 0, n = earthquakeArray.length(); i < n; i++){
                ...
                String data = earthquakes.toString();
                Log.v("extractEarthquakes", data);
            }
